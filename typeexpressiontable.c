...
{
	printf("Populating type Expression Table.....\n");
	int num_variables=0;
    ...
    printf("Type Expression Table populated.\n");
    return ;
...
void printTypeExpressionTable(typeExpressionTable T)
{
	...
	printf("============================================================");
	printf("============================================================\n");
	printf("Name\t|\tType\t|\tMemory Allocation\t|\tType Expression\n");
	printf("============================================================");
	printf("============================================================");
	printf("============================================================\n");
